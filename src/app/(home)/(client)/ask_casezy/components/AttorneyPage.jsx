    ...
    <div className="max-w-[1440px] mx-auto w-11/12 pt-28">
      ...
      <div className="space-y-4 h-[60vh] overflow-y-auto m-4 px-4">
        ...
        <div className="flex justify-end text-left">
          <p className="text-left rounded-lg py-2 px-3 bg-primary text-white max-w-11/12 sm:max-w-9/12 md:max-w-7/12">
        ...
        <div className="flex items-start">
          <p className="text-wrap text-left rounded-lg py-2 px-3 bg-secondary max-w-11/12 sm:max-w-9/12 md:max-w-7/12">
            Lorem ipsum dolor, siuatur possimus asdfsa dfsdaf asdf sadf sadfsad
            gasghsadgh sa veniam consequatur
          </p>
        </div>
        <div className="flex justify-end text-left">
          <p className="text-left rounded-lg py-2 px-3 bg-primary text-white max-w-11/12 sm:max-w-9/12 md:max-w-7/12">
      ...
      <div className="flex justify-between items-center space-x-3 p-4 sm:p-6 bg-secondary rounded-xl">
        <textarea
          ...
          className={`flex-1 p-3 rounded-lg resize-none text-white focus:ring-2 focus:ring-blue-500 focus-blue-500 focus:outline-none bg-BG`}
          rows={1}
        />
