// src/components/AttorneyList/Modals.jsx
import { ChevronDown, Loader2, X } from "lucide-react";
import Image from "next/image";
import { useState } from "react";
import { FaStar } from "react-icons/fa";

// --- Constants (repeated here for file independence) ---
...
export const AttorneyProfileModal = ({
  ...
  const handleRequestConsult = () => {
    openConsultModal();
    closeModal();
  }; // Reconstruct profile data from attorney prop for clear display mapping

  const profileData = {
    name: attorney.name,
    firm: "Doe Law PLLC",
    location: "Detroit, MI",
    score: attorney.score, // Extracting details from the description array or setting defaults
    quickFacts: [
      {
        label: "Responds in",
        value:
    ...
    summary: attorney.description[attorney.description.length - 1], // Last item is the narrative summary
