...
const generateCalendarDays = (date) => {
  ...
  while (day <= endDate) {
    days.push({
      ...
      hasEvent: MOCK_EVENTS.some((event) =>
...
const INITIAL_DATE = new Date(2025, 11, 15);
  ...
  return (
    <div className={` bg-secondary p-6`}>
      ...
      <div className={`max-w-5xl mx-auto`}>
        ...
        <div className="grid grid-cols-7 gap-1.5">
          {dayLabels.map((day) => (
            <div
              key={day}
              className="text-center text-sm md:text-base font-medium text-gray p-2"
            >
              {day}
            </div>
          ))}
      ...
      <div className="max-w-4xl mx-auto mt-12">
        ...
        <div
          className={`rounded-xl divide-y divide-gray-700/50 space-y-2 overflow-y-auto`}
        >
